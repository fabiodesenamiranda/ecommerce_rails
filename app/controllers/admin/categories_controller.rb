class Admin::CategoriesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_category.save
        format.html { redirect_to admin_category_url(@admin_category), notice: "CCategoria criada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_categories_path, status: :see_other, notice: "Categoria deletada com sucesso." }
